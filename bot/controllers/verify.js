    ...
    const ctrls = [{
      ...
      action: (message, ctrl, msg) => {
        ...
        const collector = message.channel.createMessageCollector(
          ...
          { time: 15000 });
        collector.on('collect', m => util.log('Collected', m.content, 3));
        collector.on('end', collected => util.log('Items', collected.size, 3));
        // TODO: Email code to supplied email address `email`
